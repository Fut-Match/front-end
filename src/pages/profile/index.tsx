  ...
  const achievements = [
    {
      ...
      description: 'Marcou 5 hat-tricks',
      icon: Target,
      completed: true,
    },
    {
      title: 'Artilheiro',
      description: 'Mais de 50 gols',
      icon: Trophy,
      completed: true,
    },
    {
      title: 'Assistente Real',
      description: 'Mais de 30 assistências',
      icon: Users,
      completed: true,
    },
    {
      title: 'MVP Legend',
      description: '10 títulos de MVP',
      icon: Star,
      completed: true,
    },
    {
      title: 'Invencível',
      description: '15 vitórias seguidas',
      icon: Shield,
      completed: false,
    },
  ]
    ...
    <div className="min-h-screen bg-gray-50 p-4 pb-20">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-600">
              "{playerData.nickname}" • {playerData.position}
            </p>
          ...
          <div className="text-right">
            ...
            <div className="w-20 bg-gray-200 rounded-full h-2 mt-1">
              <div
                ...
                style={{
                  width: `${(playerData.experience / playerData.experienceToNext) * 100}%`,
                }}
              ></div>
            </div>
          </div>
        ...
        <div className="mt-4 text-xs text-gray-500 flex items-center">
          ...
          Jogando desde{' '}
          {new Date(playerData.joinDate).toLocaleDateString('pt-BR')}
        </div>
      </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="font-medium">
                  {stats.detailed.goalsPerMatch}
                </span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <span className="text-gray-600">Assistências por partida</span>
                <span className="font-medium">
                  {stats.detailed.assistsPerMatch}
                </span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
