          ...
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className="text-left">
              ...
              <div className="text-yellow-100">
                ...
                {matchDetails.mvp.assists &&
                  `${matchDetails.mvp.assists} assistências`}
                {matchDetails.mvp.tackles &&
                  `${matchDetails.mvp.tackles} desarmes`}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <div className="text-2xl font-bold text-[#F2442E]">
              {Math.round(
                (matchDetails.duration / matchDetails.participants) * 10
              ) / 10}
            </div>
          ...
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <div className="text-2xl font-bold text-green-600">
              {matchDetails.topScorer.goals +
                (matchDetails.topAssister.assists || 0)}
            </div>
