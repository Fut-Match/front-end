                ...
                <div key={player.id} className="flex flex-col gap-3 p-3 rounded-lg border">
                  ...
                  <div className="flex flex-col gap-2">
                    <Button
                      ...
                      className={`w-full justify-center gap-2 ${player.isConfirmed ? 'text-green-600 border-green-600' : ''
                        }`}
                    >
                    ...
                    <Button
                      ...
                      className={`w-full justify-center gap-2 ${player.hasPaid ? 'text-green-600 border-green-600' : 'text-yellow-600 border-yellow-600'
                        }`}
                    >
