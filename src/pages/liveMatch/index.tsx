...
import { Play, Pause, Square, Target, Users, Shield, RefreshCw, Flame, Crown, ArrowLeft } from 'lucide-react';
...
const LiveMatchScreen: React.FC<LiveMatchScreenProps> = ({ onNavigate, match }) => {
  ...
  const [playerStats, setPlayerStats] = useState<{ [key: number]: { goals: number; assists: number; tackles: number } }>({});
  const [isLastMatch, setIsLastMatch] = useState(false);
  const [showSubstitutionModal, setShowSubstitutionModal] = useState(false);
  const [substitutionType, setSubstitutionType] = useState<'individual' | 'team' | null>(null);
  ...
  const teams = {
    team1: [
      { id: 1, name: 'João Silva', photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face', team: 1, isPlaying: true },
      { id: 2, name: 'Pedro Costa', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face', team: 1, isPlaying: true },
      { id: 3, name: 'Carlos Lima', photo: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face', team: 1, isPlaying: true },
      { id: 4, name: 'Roberto Alves', photo: 'https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=100&h=100&fit=crop&crop=face', team: 1, isPlaying: true },
      { id: 9, name: 'Marcos Souza', photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face', team: 1, isPlaying: false },
      { id: 10, name: 'Lucas Ferreira', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face', team: 1, isPlaying: false },
    ],
    team2: [
      { id: 5, name: 'Maria Santos', photo: 'https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=100&h=100&fit=crop&crop=face', team: 2, isPlaying: true },
      { id: 6, name: 'Ana Oliveira', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face', team: 2, isPlaying: true },
      { id: 7, name: 'Lucia Ferreira', photo: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop&crop=face', team: 2, isPlaying: true },
      { id: 8, name: 'Fernanda Souza', photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&h=100&fit=crop&crop=face', team: 2, isPlaying: true },
      { id: 11, name: 'Carla Ribeiro', photo: 'https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=100&h=100&fit=crop&crop=face', team: 2, isPlaying: false },
      { id: 12, name: 'Júlia Pereira', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face', team: 2, isPlaying: false },
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 pb-20">
      ...
      <div className="mb-6">
        <h1 className="text-lg font-medium text-gray-700 text-center">⚽ Partida ao Vivo</h1>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
        ...
        <div className="flex items-center justify-center space-x-8">
          <div className="text-center">
            <div className={`text-3xl font-bold ${score.team1 >= 5 && isLastMatch ? 'text-yellow-600' : 'text-blue-600'}`}>
              {score.team1}
              {score.team1 >= 5 && isLastMatch && <Crown className="h-6 w-6 inline ml-2 text-yellow-600" />}
            </div>
            <div className="text-sm text-gray-600">Time 1</div>
          </div>
          <div className="text-2xl font-bold text-gray-400">x</div>
          <div className="text-center">
            <div className={`text-3xl font-bold ${score.team2 >= 5 && isLastMatch ? 'text-yellow-600' : 'text-red-600'}`}>
              {score.team2}
              {score.team2 >= 5 && isLastMatch && <Crown className="h-6 w-6 inline ml-2 text-yellow-600" />}
            </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm">
          ...
          <div className="space-y-3">
            {getPlayingPlayers(1).map((player) => (
              <div key={player.id} className="bg-white border-2 border-blue-200 rounded-lg p-4 shadow-sm">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">
                      G: {playerStats[player.id]?.goals || 0} | 
                      A: {playerStats[player.id]?.assists || 0} | 
                      D: {playerStats[player.id]?.tackles || 0}
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-green-700">Gol</span>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-blue-700">Assist</span>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-purple-700">Desarme</span>
                  </button>
                </div>
              </div>
            ))}
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm">
          ...
          <div className="space-y-3">
            {getPlayingPlayers(2).map((player) => (
              <div key={player.id} className="bg-white border-2 border-red-200 rounded-lg p-4 shadow-sm">
                <div className="flex items-center space-x-3 mb-4">
                  <ImageWithFallback
                    src={player.photo}
                    alt={player.name}
      ...
      {showSubstitutionModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[80vh] overflow-y-auto">
            <div className="text-center mb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Substituição</h3>
            ...
            <div className="space-y-4">
              ...
              {substitutionType === 'individual' && (
                <div className="space-y-3">
                  <h4 className="font-medium">Selecione o jogador para substituir:</h4>
                  <div className="max-h-48 overflow-y-auto space-y-2">
                    {[...getPlayingPlayers(1), ...getPlayingPlayers(2)].map((player) => (
                      <button
                        key={player.id}
                      ...
                      >
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-sm text-gray-600">Time {player.team}</div>
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              {substitutionType === 'team' && (
                <div className="space-y-3">
                  <h4 className="font-medium">Selecione o time para substituir:</h4>
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-600">{getPlayingPlayers(1).length} jogadores</div>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-600">{getPlayingPlayers(2).length} jogadores</div>
                    </button>
                  </div>
                </div>
              )}
