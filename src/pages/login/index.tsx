    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex flex-col justify-center px-6">
      <div className="max-w-md mx-auto w-full">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-semibold text-gray-900 mb-2">Bem-vindo ao FutMatch</h1>
          <p className="text-gray-600">Entre na sua conta e organize suas partidas</p>
        </div>
